...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    if(data.success){
                        ...
                        // 需要在textarea文本域上方添加一个div显示添加的备注信息
                        var html = "";
                        ...
                        html +='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small id="u'+data.ar.id+'"style="color: gray;"> '+data.ar.createTime+' 由'+data.ar.createBy+'</small>';
                        html +='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                        //javascript:void(0);表示将超链接禁用，只能以触发事件的形式来操作
        ...
        $("#updateRemarkBtn").click(function (){
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    /*
                        data
                            {"success":true/false,"ar",活动备注对象}
                     */
                    if(data.success){

                        //修改备注成功
                        //更新div中相应的信息，包括：noteContent，editBy，editTime
                        $("#e"+id).html(data.ar.noteContent);
                        $("#u"+id).html(data.ar.editTime+" 由"+data.ar.editBy);
	...
	function showRemarkList() {
		...
		$.ajax({
			...
			data: {
				"activityId":"${a.id}"  //JS代码中使用EL表达式必须套用在""中
			},
			type:"get",
			dataType:"json",
			success:function (data) {
				...
				$.each(data,function (i,n) {
                    ...
                    html +='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small id="'+n.id+'+"style="color: gray;"> '+(n.editFlag==0?n.createTime:n.editTime)+' 由'+(n.editFlag==0?n.createBy:n.editBy)+'</small>';
                    html +='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                    //javascript:void(0);表示将超链接禁用，只能以触发事件的形式来操作
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                if(data.success){
                    ...
                    //这种做法不行,记录使用的是before方法，每一次删除后，都保留原有的数据
                    //showRemarkList();
