...
<script type="text/javascript">
	...
	$(function(){
		...
		//为关联市场活动按钮绑定事件，打开关联市场活动的模态窗口
		$("#openBundBtn").click(function (){
...
<body>
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);" id="openBundBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
