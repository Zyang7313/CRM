...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#findBtn").click(function (){
			...
			$("#hidden-state").val($.trim($("#search-state>option:selected").val()));
	...
	/*
		...
		clueList方法:就是发出ajax请求到后台，从后台取得最新的线索信息列表数据
					通过响应回来的数据，局部刷新线索信息列表

		我们都在哪些情况下，需要调用pageList方法(什么情况下需要刷新一下线索列表)
			(1)点击左侧菜单中的"线索"超链接，需要刷新线索列表，需要调用pageList方法
			(2)添加，修改，删除后，需要刷新线索列表，需要调用pageList方法
			(3)点击查询按钮的时候，需要刷新线索列表，需要调用pageList方法
			(4)点击分页组件的时候，需要刷新线索列表，需要调用pageList方法
		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data.dataList,function (i,n) {
					...
					html += '<tr><td><input type="checkbox" name="xz" id="'+n.id+'"/></td>';
